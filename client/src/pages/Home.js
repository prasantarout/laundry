...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Link className="w3-bar-item w3-left" to={"/Home"}>Home</Link>
      <Link className="w3-bar-item w3-left" to={`/Details/byId/${User.id}`}>User Details</Link>
      {!token || 
      <button onClick={logOut} style={{width : '110px', height : '45px'}} className="w3-bar-item w3-right">Logout</button>
      }
              ...
              <nav className="w3-sidebar w3-collapse w3-white w3-animate-left" style={{ zIndex: 3, width: '300px' }} id="mySidebar"><br />
                <div className="w3-container w3-row">
                  <div className="w3-col s4">
                    <img src={require("../images/Avatar.png")} alt="avatar" style={{ width: '46px' }} />
                  </div>
                ...
                <div className="w3-bar-block">
                  <a href="#requestStatus" className="w3-bar-item w3-button w3-padding"><i className="fa fa-eye fa-fw" />&nbsp; Request Status</a>
        ...
        <div id="requestStatus" className="w3-row-padding w3-margin-bottom">
          ...
          <div className="w3-quarter">
            <div className="w3-container w3-teal w3-padding-16">
              <div className="w3-left"><i className="fas fa-laugh-beam w3-xxxlarge" /></div>
              <div className="w3-right">
                <h3>0</h3>
              </div>
              <div className="w3-clear" />
          ...
          <div className="w3-quarter">
            <div className="w3-container w3-orange w3-text-white w3-padding-16">
              <div className="w3-left"><i className="fas fa-kiss-wink-heart w3-xxxlarge" /></div>
              <div className="w3-right">
                <h3>0</h3>
              </div>
              <div className="w3-clear" />
        ...
        <div className="w3-container" id = 'aboutUs'>
          ...
          <div className="w3-row">
            ...
            "Cleansing removes the residual influence of earlier experience," 
            Lee said in a statement. We are also familiar with the saying, "Cleanliness is next to Godliness."
            </div>
          </div>
          <div className="w3-row">
            <div style={{display :' flex'}} className="w3-col m2 text-center">
              <img className="w3-rectangle" src={require("../images/Laundry1.jpg")} alt="1" style={{width: '400px', height: '200px'}} />
              <img className="w3-rectangle" src={require("../images/Laundry2.jpg")} alt="2" style={{width: '500px', height: '200px'}} />
              <img className="w3-rectangle" src={require("../images/Laundry3.jpg")} alt="3" style={{width: '400px', height: '200px'}} />
            </div>
          </div>
        </div>
        <br />
        ...
        <footer className="w3-container w3-padding-16 w3-light-grey">
          <h4>FOOTER</h4>
          <p>Devloped by Nishikanta Sahoo</p>
        </footer>
        {/* End page content */}
      </div>
              </>
